package com.oride.vendor.presentation.activities
...
import com.oride.vendor.databinding.ActivityMainBinding
import com.oride.vendor.presentation.base.BaseActivity
...
class MainActivity : BaseActivity<ActivityMainBinding>() {
    ...
    private fun setListeners() {
        ...
        binding.ivVendorPhoto.setOnClickListener {
        ...
        binding.topSheet.tvDishes.setOnClickListener {
            isTopSheetVisible = !isTopSheetVisible
            binding.topSheet.root.visibility = View.GONE
            if (navController.currentDestination?.id != R.id.dishesFragment) navController.navigate(R.id.dishesFragment)
        }
    }
}